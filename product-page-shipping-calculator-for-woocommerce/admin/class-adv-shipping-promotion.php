...
class Class_Pi_Sales_Adv_Shipping_Promotion{
    ...
    private $this_tab = 'adv_shipping_promotion';

    private $tab_name = "Conditional Shipping";

    private $setting_key = 'pi_dtt_adv_shipping_promotion';

    public $pi_sn_translate_message;

    public $tab;

    public $plugin_slug = 'advanced-free-flat-shipping-woocommerce';
    ...
    function tab(){
        ...
        <img src="<?php echo esc_url( plugins_url( 'img/shipping-icon.svg', __FILE__ ) ); ?>" class="tab-icon">  <?php echo esc_html( $this->tab_name ); ?>
        </a>
        <?php
    }
...
add_action('init', function(){
    new Class_Pi_Sales_Adv_Shipping_Promotion($this->plugin_name);
});